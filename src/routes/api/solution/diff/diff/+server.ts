...
import { DifferentiationProblem, DifferentiationSolver } from '$lib/server/differentiationProblem';
...
export const POST: RequestHandler = async ({ request, locals }) => {
	...
	const problem = new DifferentiationProblem(JSON.stringify(dataJson));
	...
	const problemSolved = new DifferentiationSolver(problem);
