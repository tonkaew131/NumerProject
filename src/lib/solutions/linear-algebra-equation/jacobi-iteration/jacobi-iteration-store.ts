...
import type { JacobiIterationMethodResult } from './jacobi-iteration';
...
const store = writable<{
	input: inputData;
	loading: boolean;
	result: JacobiIterationMethodResult | null;
}>({
	input: {
...
const setResult = (result: JacobiIterationMethodResult) => {
